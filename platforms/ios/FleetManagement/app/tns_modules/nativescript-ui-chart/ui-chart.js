...
var RadCartesianChart = /** @class */ (function (_super) {
    ...
    /** Finds the corresponding palette item for selected series
         ...
         * @param seriesIndex - the index of series in {N} chart's series collection
         */
    RadCartesianChart.prototype.getPaletteItemWithIndexForStateOfSeries = /** Finds the corresponding palette item for selected series
         * @param nativeIndex - the index of series in native control
         * @param seriesIndex - the index of series in {N} chart's series collection
         */
    function (state, nativeIndex, seriesIndex) {
        var item = null;
