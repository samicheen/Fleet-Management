...
*/
export namespace SeriesStackMode {
    /**
 ...
 */
declare namespace SeriesSelectionMode {
    /**
...
declare namespace TrackballSnapMode {
    /**
...
*/
declare namespace ChartLegendPosition {
    /**
...
*/
declare namespace ChartLegendOffsetOrigin {
    /**
...
*/
export namespace PaletteEntryUseState {
    /**
...
*/
declare namespace AxisLabelFitMode {
    /**
 ...
 */
declare namespace AxisLabelLayoutMode {
    /*
...
*/
declare namespace AxisHorizontalLocation {
    /**
...
*/
declare namespace AxisVerticalLocation {
    /**
...
declare class LinearAxis extends CartesianAxis {
    ...
    * In case of DateTimeContinuousAxis you should use values exported from namespace {@link DateTimeComponent}.
    */
    majorStep: string;
}
...
* The majorStep property should use values exported from namespace {@link DateTimeComponent}.
*/
declare class DateTimeContinuousAxis extends LinearAxis {
    ...
    */
    ...
    /**
    * Gets or sets plot mode for the axis. Use {@link AxisPlotMode} namespace for possible values.
    */
    plotMode: string;
}
...
declare class Palette extends ViewBase {
    ...
    */
    ...
    /**
    * Identifies the {@link seriesState} dependency property. Use values exported from {@link PaletteEntryUseState} namespace.
    */
